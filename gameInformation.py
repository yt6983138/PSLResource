...
def run(path):
    ...
    with open("./gameInformation.raw", "wb") as _gi:
        _gi.write(information)
    with open("./tips.raw", "wb") as _gi:
        _gi.write(information)
    with open("./collection.raw", "wb") as _gi:
        _gi.write(information)
...
if __name__ == "__main__":
    run(sys.argv[1])
    #run("""G:\Large files\main.82.com.PigeonGames.Phigros\PhigrosLibrary_Resource\new\3.5\main.98.com.PigeonGames.Phigros.obb""")
